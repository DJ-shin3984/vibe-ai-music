...
const PROMPT_BOX_STYLES = `
  .ai-prompt-box *:focus-visible { outline-offset: 0 !important; --ring-offset: 0 !important; }
      ...
      <TooltipProvider>
        <PromptInputContext.Provider
          value={{
            ...
            setValue: onValueChange ?? setValue,
            maxHeight,
            onSubmit,
            disabled,
          }}
...
export const PromptInputBox = React.forwardRef<HTMLDivElement, PromptInputBoxProps>(
  function PromptInputBox(
    { onSend = () => {}, isLoading = false, placeholder = "메시지를 입력하세요...", className },
    ref
  ) {
    ...
    const handleDrop = (e: React.DragEvent) => {
      e.preventDefault();
      e.stopPropagation();
      const imageFiles = Array.from(e.dataTransfer.files).filter(isImage);
      if (imageFiles[0]) processFile(imageFiles[0]);
    };
    ...
    return (
      <>
        <PromptInput
          ...
          className={cn(
            "w-full bg-[#1F2023] border-[#444444] shadow-[0_8px_30px_rgba(0,0,0,0.24)]",
        ...
        >
          ...
          <div className={cn(isRecording && "h-0 overflow-hidden opacity-0")}>
            <PromptInputTextarea
              placeholder={
                showSearch
                  ? "Search the web..."
          ...
          <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
            <div
              className={cn(
                ...
                isRecording && "opacity-0 invisible h-0"
              )}
            >
              <PromptInputAction tooltip="Upload image">
                <button
                  ...
                  className="flex h-8 w-8 text-[#9CA3AF] cursor-pointer items-center justify-center rounded-full hover:bg-gray-600/30 hover:text-[#D1D5DB]"
              ...
              <div className="flex items-center">
                <button
                  ...
                  className={cn(
                    "rounded-full flex items-center gap-1 px-2 py-1 border h-8",
                    showSearch
                ...
                >
                  ...
                  >
                    <Globe className={cn("w-4 h-4", showSearch && "text-[#1EAEDB]")} />
                  </motion.div>
                  <AnimatePresence>
                    {showSearch && (
                      <motion.span
                        ...
                        className="text-xs whitespace-nowrap text-[#1EAEDB]"
                      >
                        Search
                      </motion.span>
                    )}
                ...
                >
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 260, damping: 25 }}
                  >
                    <BrainCog className={cn("w-4 h-4", showThink && "text-[#8B5CF6]")} />
                  </motion.div>
                  <AnimatePresence>
                    {showThink && (
                      <motion.span
                        ...
                        animate={{ width: "auto", opacity: 1 }}
                        exit={{ width: 0, opacity: 0 }}
                        className="text-xs whitespace-nowrap text-[#8B5CF6]"
                      >
                        Think
                      </motion.span>
                    )}
                ...
                >
                  <motion.div
                    ...
                    transition={{ type: "spring", stiffness: 260, damping: 25 }}
                  >
                    <FolderCode className={cn("w-4 h-4", showCanvas && "text-[#F97316]")} />
                  </motion.div>
                  <AnimatePresence>
                    {showCanvas && (
                      <motion.span
                        ...
                        animate={{ width: "auto", opacity: 1 }}
                        exit={{ width: 0, opacity: 0 }}
                        className="text-xs whitespace-nowrap text-[#F97316]"
                      >
                        Canvas
                      </motion.span>
                    )}
            ...
            >
              <Button
                ...
                className={cn(
                  ...
                  hasContent && !isRecording && "bg-white hover:bg-white/80 text-[#1F2023]",
                  !hasContent && !isRecording && "bg-transparent hover:bg-gray-600/30 text-[#9CA3AF]"
                )}
                onClick={() => {
